                        ...
                        <div class="form-row">
                           ...
                           <div class="form-group col-md-6">
                              ...
                              <select name="insurance_id"
                                 ...
                                 <option value="{{$item->insurance_id}} ">{{$item->insurance->name}} </option>
                        ...
                        <div class="form-row">
                           ...
                           <div class="form-group col-md-6">
                              ...
                              <select name="cover_type_id" 
                                 ...
                                 <option value="{{$item->cover_type_id}} ">{{$item->covertype->deskripsi}} </option>
                           ...
                           <div class="form-group col-md-4">
                              ...
                              <div class="input-group mb-3">
                                 <select name="currency_id" 
                                    class="form-control select2 @error('insurance_id') is_invalid @enderror">
                                    <option value="{{$item->currency_id}} ">{{$item->currency_id}} - {{$item->currency->mata_uang}} </option>
