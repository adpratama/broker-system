                  ...
                  <div class="form-row">
                     ...
                     <div class="form-group col-md-7">
                        ...
                        <input type="text" 
                           ...
                           name="nama_bank" 
                           id="nama_bank" 
                           value="{{old('nama_bank')?old('nama_bank'):$item->nama_bank}} @error('nama_bank') is-invalid @enderror ">
                           @error('nama_bank')
                              <div class="text-muted">{{ $message}} </div>
                           @enderror
                     </div>
                  ...
                  <div class="form-row">
                     ...
                     <div class="form-group col-md-7">
                        ...
                        <input type="text" 
                           ...
                           name="atas_nama" 
                           id="atas_nama" 
                           value="{{old('atas_nama')?old('atas_nama'):$item->atas_nama}} @error('atas_nama') is-invalid @enderror ">
                           @error('atas_nama')
                              <div class="text-muted">{{ $message}} </div>
                           @enderror
                     </div>
